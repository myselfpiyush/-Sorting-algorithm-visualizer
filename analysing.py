...
def draw_list(draw_info, color_positions={}, clear_bg=False):
    ...
    if clear_bg:
        clear_react = (draw_info.SIDE_PAD // 2, draw_info.TOP_PAD, draw_info.width - draw_info.SIDE_PAD,
...
def selection_sort(draw_info, ascending=True):
    ...
    for i in range(len(lst)):
        ...
        for j in range(i + 1, len(lst)):
            if lst[min_index] > lst[j] and ascending:
                min_index = j
            if lst[min_index] < lst[j] and not ascending:
                min_index = j
